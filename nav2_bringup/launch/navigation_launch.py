        ...
        actions=[
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level,
                           ...
                           '--log-level', 'local_costmap.local_costmap_voxel_layer_mf:=warn',
                           '--log-level', 'local_costmap.local_costmap_floor_stvl_layer_mf:=warn',
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level, 
                           ...
                           '--log-level', 'global_costmap.global_costmap_voxel_layer_mf:=warn',
                           '--log-level', 'global_costmap.global_costmap_floor_stvl_layer_mf:=warn',
                           '--ros-args', '--disable-rosout-logs', '--disable-external-lib-logs'],
                remappings=remappings,
            ),
            Node(
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level,
                           '--ros-args', '--disable-rosout-logs', '--disable-external-lib-logs'],
                parameters=[{'autostart': autostart, 'node_names': lifecycle_nodes, 'bond_timeout': 10.0}, configured_params],
            ),
        ],
    )
