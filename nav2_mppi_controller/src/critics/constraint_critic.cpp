...
void ConstraintCritic::initialize()
{
  ...
  getParentParam(vx_max, "vx_max", 0.5f, ParameterType::Static);
  getParentParam(vy_max, "vy_max", 0.0f, ParameterType::Static);
  getParentParam(vx_min, "vx_min", -0.35f, ParameterType::Static);
